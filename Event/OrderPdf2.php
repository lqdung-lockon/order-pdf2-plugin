...
namespace Plugin\OrderPdf2\Event;
 ...
 */
class OrderPdf2 extends CommonEvent
{
    /**
    ...
    public function onAdminOrderIndexRender(TemplateEvent $event)
    {
        ...
        $twigAppend = $twig->getLoader()->getSource('OrderPdf2/Resource/template/admin/order_pdf_menu.twig');
        /**
